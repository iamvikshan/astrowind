...
excerpt: While easy to get started, Astrowind is quite complex internally.  This blog provides documentation on some of the more intricate parts.
...
_Dark Mode_ is triggered by the little <ToggleTheme/> icon in the page header. It is defined in the _components/common/ToggleTheme.astro_, but the event is attached and the action defined in _components/common/BasicScripts.astro_ in the following snippet:
