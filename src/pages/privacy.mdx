...
- Visit our website at <a href={getPermalink()} taeget = "_target">vikshan.tech</a>, or any website of ours that links to this privacy notice,
...
**How do you exercise your rights?** The easiest way to exercise your rights is by visiting our <a href={getPermalink('/contact')} target="\_blank">contact</a> page, or by contacting us via [mail](mailto:privacy@vikshan.tech). We will consider and act upon any request in accordance with applicable data protection laws.
...
- We use **Google Analytics** on our short url service <a href={getShortUrl()} target="_blank">go.vikshan.tech</a> (we use **Short.io** to manage our short urls) and <a href="https://ko-fi.com/vikshan" target="_blank">ko-fi.com/vikshan</a> (we use **Ko-Fi** to accept donations)
...
2. **Simple Analytics** via <a href={getPermalink()} taeget = "_target">vikshan.tech</a>
...
3. **Cloudflare** via the domain <a href={getPermalink()} taeget = "_target">vikshan.tech</a> and it's subdomains. We use Cloudflare to protect our website from DDoS attacks and to provide you with a faster and more secure experience.
...
To exercise these rights, you can contact us by visiting our <a href={getPermalink('/contact')} taeget = "\_target">contact</a> page, by email us at [privacy@vikshan.tech](mailto:privacy@vikshan.tech), or by referring to the contact details at the bottom of this document. If you have a complaint about how we handle your data, we would like to hear from you.
...
To submit a request to exercise these rights described above, please email [privacy@vikshan.tech](mailto:privacy@vikshan.tech) or visit our <a href={getPermalink('/contact')} taeget = "\_target">contact</a> page.
...
You may contact us by email at [privacy@vikshan.tech](mailto:privacy@vikshan.tech) or visit our <a href={getPermalink('/contact')} taeget = "\_target">contact</a> page.
...
You have the right to request access to the personal information we collect from you, change that information, or delete it. To request to review, update, or delete your personal information, please visit our <a href={getPermalink('/contact')} target="\_blank">contact</a> page or mail us at privacy@vikshan.tech.

<div class="analytics-badge">
  <a
    href="https://simpleanalytics.com/vikshan.tech?utm_source=vikshan.tech&utm_content=badge"
    referrerpolicy="origin"
    target="_blank"
  >
    <picture>
      <source
        srcset="https://simpleanalyticsbadges.com/vikshan.tech?mode=dark&radius=10&logo=38bdf8"
        media="(prefers-color-scheme: dark)"
      />
      <img
        src="https://simpleanalyticsbadges.com/vikshan.tech?mode=light&radius=10&logo=38bdf8"
        loading="lazy"
